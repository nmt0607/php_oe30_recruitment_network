                ...
                <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
                    <ul id="myTab" class="nav nav-tabs" role="tablist">
                        <li role="presentation" id="approved_job" class="active">
                            <a href="" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true">@lang('admin.approved_job')</a>
                        </li>
                        <li role="presentation" id="unapproved_job">
                            <a href="" role="tab" id="profile-tab" data-toggle="tab" aria-controls="profile">@lang('admin.unapproved_job')</a>
                        </li>
                    </ul>
                                    ...
                                    <div class="jobs-item with-thumb">
                                        ...
                                        <div class="jobs_right">
                                            ...
                                            <div class="col-md-2 single_right">
                                                <a href="{{ route('approve_job', ['id' => $job->id]) }}">@lang('admin.approve')</a>
                                            </div>
                                        </div>
                                        <div class="clearfix"> </div>
                                    </div>
